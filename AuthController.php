...
class AuthController extends Controller
{
     ...
     * Pass branch_id = null (or omit it) to reset to "All Branches" view.
     */
    public function switchBranch(Request $request): JsonResponse
    {
        ...
        // Accept nullable branch_id — null means "all branches" context
        ...
        $message = $data['branch_id']
            ? 'Switched to branch: ' . $user->branch->name
            : 'Switched to All Branches view';
