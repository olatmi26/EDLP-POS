...
function AnalyticsTab({ products, loading }) {
  ...
  if (loading) {
    return <div style={{ padding: 40, textAlign: 'center' }}><Spinner size={24} /></div>
  }
          ...
          {categoryData.map(([cat, data]) => (
            <div key={cat}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 3 }}>
                <span style={{
                  fontSize: 12, color: '#3A4A5C', fontWeight: 500,
                  overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: 160,
                }}>{cat}</span>
                <div style={{ display: 'flex', gap: 8 }}>
                  {data.lowStock > 0 && (
                    <span style={{ fontSize: 11, color: '#C45A00', fontWeight: 600 }}>
                      {data.lowStock} low
                    </span>
                  )}
              ...
              <div style={{ height: 5, background: '#F0F4F8', borderRadius: 4 }}>
                <div style={{
                  ...
                  height: '100%', background: '#E8A020', borderRadius: 4,
                }} />
              </div>
            </div>
          ))}
            ...
            <div key={p.name}>
              ...
              <div style={{ height: 5, background: '#F0F4F8', borderRadius: 4 }}>
                <div style={{
                  ...
                  height: '100%',
                  background: p.margin >= 30 ? '#1A6E3A' : '#E8A020',
                  borderRadius: 4,
                }} />
              </div>
            </div>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      {/* ══════════════════════════════════════════════════════════════════
          ...
          ══════════════════════════════════════════════════════════════════ */}
      {activeTab === 'Analytics' && (
        <AnalyticsTab products={allProducts} loading={allProductsQ.isLoading} />
      )}
